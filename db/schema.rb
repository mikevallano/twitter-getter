...
ActiveRecord::Schema.define(version: 2020_03_06_213259) do
  ...
  create_table "liked_tweets", force: :cascade do |t|
    ...
    t.bigint "twitter_object_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["twitter_object_id"], name: "index_liked_tweets_on_twitter_object_id"
  ...
  create_table "twitter_objects", force: :cascade do |t|
    t.bigint "tweet_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["tweet_id"], name: "index_twitter_objects_on_tweet_id"
  end
  ...
  add_foreign_key "liked_tweets", "twitter_objects"
